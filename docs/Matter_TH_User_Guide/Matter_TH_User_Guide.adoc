...
PIXIT type parameters must be filled in in the section (*test_parameters*).
...
The following example will be used to define the following parameters when running the test:
