...
| Matter 1.3       | TH-Spring2024| https://drive.google.com/file/d/1XOQolEPUhJWYSKty2_FfsmhraTCtGvqP/view?usp=drive_link[link]          | https://groups.csa-iot.org/wg/matter-csg/document/folder/3314[Causeway Link] | 0ff709f      | Not Official - TE2 Version
|===
...
The official installation method uses a Raspberry Pi (<<th-image-installation-on-raspberry-pi>>). **This alternative installation method is targeted for development purpose and it is only support onnetwork pairing mode.**
