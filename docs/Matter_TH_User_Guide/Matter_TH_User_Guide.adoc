...
| Matter 1.4.2       | v2.13+summer2025   | N/A                                                                                         |                                                                               | a12250a      | To install, use the tag "v2.13-beta4+summer2025" in the instructions of <<fresh_install>>
|===
...
The test procedures and test commands for Wi-Fi PAF commissioning are documented in Test Plan Verification spreadsheet on a Matter Specifications and Test Plans folder:
