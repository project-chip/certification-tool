...
| 76          | 23-Sep-2026  | [Apple]Romulo Quidute               | * Updated OTBR docker image references in the Thread dataset generation section to match the new default (`openthread/otbr` digest-pinned image), replacing the obsolete `nrfconnect/otbr:9185bda`.
|===
...
openthread/otbr@sha256:aa02bd1534984be704c84a575f97412c71fab504e6e1f094d0de4e06bfe46cf3   083c8472bc52   10 months ago   1.21GB +
otbr image openthread/otbr@sha256:aa02bd1534984be704c84a575f97412c71fab504e6e1f094d0de4e06bfe46cf3 already installed
...
+
|===
|`sudo docker run -it --rm --privileged --network otbr -p 8080:80 --sysctl "net.ipv6.conf.all.disable_ipv6=0 net.ipv6.conf.all.forwarding=1" --name otbr -e NAT64=0 --volume /dev/ttyACM0:/dev/ttyACM0 openthread/otbr@sha256:aa02bd1534984be704c84a575f97412c71fab504e6e1f094d0de4e06bfe46cf3 --radio-url spinel+hdlc+uart:///dev/ttyACM0`
|===
