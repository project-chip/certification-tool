...
[discrete]
== *Overview of Test Harness to be used for each Matter version*

// intro text copied from https://community.csa-iot.org/page/matter-th
The Test Harness is backwards compatible since Matter v1.4: you should use the latest test harness version (see bottom row of the table) for testing Matter versions Matter v1.4 and beyond.
Apart from test improvements, it contains various other compatibility fixes and UI/CLI testing improvements to assist you better in performing testing.
In case of issues using the latest Test Harness, you may fall back to the earlier Matter Test Harness version as used at the applicable(version) SVE (see 3rd column),
while filing a https://zigbeecertifiedproducts.knack.com/zigbee-alliance-ccb-tool#home/[CCB] against the latest Test Harness version for the problem you encountered.

Specification versions marked with `(Sunset)` in the table have been sunset and are closed for new certifications. They can only be used for re-certification of previously certified products.

//[cols=".^10%,.^25%,.^10%,.^20%,.^10%,.^25%"]
|===
| *Matter Version*      | *TH Version* | *Fallback in case of issues with latest TH* | *TH image location*                                                                          | *Supporting Documentation*                                                    | *SDK commit*
| Matter 1.0 `(Sunset)` | TH-v2.6                   | N/A                | https://drive.google.com/file/d/10YkV4mDulhLoA6RJOKZNNKWhHTH1tOfu/view?usp=drive_link[Google Drive link] | https://groups.csa-iot.org/wg/members-all/document/folder/2729[Causeway Link] | 96c9357
| Matter 1.1 `(Sunset)` | TH-v2.8.1                 | N/A                | https://drive.google.com/file/d/15fU3L7QE-MNBslf53A_6sFgn1Wq0Pvqd/view?usp=drive_link[Google Drive link] | https://groups.csa-iot.org/wg/members-all/document/folder/2730[Causeway Link] | 5a21d17
| Matter 1.2 `(Sunset)` | TH-Fall2023               | N/A                | https://drive.google.com/file/d/1WTjhc7xbYt18RvpABU3_r47uqOLd7NN1/view?usp=drive_link[Google Drive link] | https://groups.csa-iot.org/wg/members-all/document/folder/3045[Causeway Link] | 19771ed
| Matter 1.3 `(Sunset)` | v2.10.4+spring2024        | N/A                | To install, use the tag "v2.10.4+spring2024" in the instructions of <<fresh_install>>                    | https://groups.csa-iot.org/wg/members-all/document/folder/3361[Causeway Link] | 50bcad1
| Matter 1.4            | use the latest TH version | v2.11+fall2024     | To install, use the tag "v2.11+fall2024" in the instructions of <<fresh_install>>                        | https://groups.csa-iot.org/wg/members-all/document/folder/4120[Causeway Link] | f2e5de7
| Matter 1.4.1          | use the latest TH version | v2.12+spring2025   | To install, use the tag "v2.12+spring2025" in the instructions of <<fresh_install>>                      | https://groups.csa-iot.org/wg/members-all/document/folder/4497[Causeway Link] | 91eab26
| Matter 1.4.2          | use the latest TH version | v2.13+summer2025   | To install, use the tag "v2.13+summer2025" in the instructions of <<fresh_install>>                      | https://groups.csa-iot.org/wg/members-all/document/folder/4651[Causeway Link] | 1b2b3fd
| Matter 1.5            | use the latest TH version | v2.14+fall2025     | To install, use the tag "v2.14+fall2025" in the instructions of <<fresh_install>>                        | https://groups.csa-iot.org/wg/members-all/document/folder/4825[Causeway Link] | ca9d111
| Matter 1.5.1          | use the latest TH version | v2.14.1+winter2026 | To install, use the branch "v2.14.1+winter2026" in the instructions of <<fresh_install>>                 | https://groups.csa-iot.org/wg/members-all/document/folder/5210[Causeway Link] | e9ecfc2
| Matter 1.6            | use the latest TH version | v2.15+spring2026   | To install, use the branch "v2.15+spring2026" in the instructions of <<fresh_install>>                   | https://groups.csa-iot.org/wg/members-all/document/folder/5452[Causeway Link] | ad9cf71
| Matter 1.6.1          | {th-version}   | this is the latest TH version | To install, use the branch "{th-version}" in the instructions of <<fresh_install>>                       | https://groups.csa-iot.org/wg/members-all/document/folder/2269[Causeway Link] | e91ea83
|===
// todo: fix Causeway URL for 1.6.1 once available
...
| 66          | 14-Sep-2026  | Leo Rozendaal                       | * Align with clarification updates to the (similar/related) table on https://community.csa-iot.org/page/matter-th + some corrections
|===
