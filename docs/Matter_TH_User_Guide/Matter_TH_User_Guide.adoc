...
:th-version: v2.12-beta1+spring2025
...
| Matter 1.4.1     | v2.12+spring2025   | N/A                                                                                         |                                                                               | 7d67dc9      | To install, use the tag "v2.12-beta1+spring2025" in the instructions of <<fresh_install>>
|===
