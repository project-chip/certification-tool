...
====
At `~/certification-tool/backend/`, you may access the folder link `custom_yaml` as shortcut to access the Custom Yaml files folder. +
Similarly, you can use the `custom_python` link to access the Custom Python files folder as well. +
====
