...
| 39          | 04-Sep-2024  | [Apple] Hilton Lima                 | * Move pixit section. +
...
----
+
WARNING: _OTBR needs to be configured and running. TH will not start any OTBR dockers._
...
----
+
WARNING: This is an invalid configuration. TH will not accept both parameters set at same time.
...
Access the spreadsheet via the https://groups.csa-iot.org/wg/matter-csg/document/36336[link] and review the information provided. Based on this data, create the parameters set as requested. 
...
----
+
Arguments to be used while execution using UI (use product specific values)
+
[source,xml]
----
"test_parameters": {
