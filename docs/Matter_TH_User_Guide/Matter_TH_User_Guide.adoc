...
| Matter 1.5       | v2.13+summer2025   | N/A                                                                                         |                                                                               | e34015c      | To install, use the tag "v2.13+summer2025" in the instructions of <<fresh_install>>
|===
...
| 47          | 17-Apr-2025  | [Apple]Romulo Quidute               | * Changes fot v2.13+summer025 version:
...
* The TH will pre-select test cases that:
** Comply with the standard PICS rules.
** And **not** listed in the `dmp-test-skip.xml` (DMP file).
