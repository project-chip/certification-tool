...
:th-version: v2.15-beta3.1+spring2026
...
| Matter 1.6     | {th-version}       | N/A                                                                                         | TBD | 96b1d9b      | To install, use the branch "{th-version}" in the instructions of <<fresh_install>>
|===
...
This section provides a guide to enable NFC commissioning tests. NFC interface can be used to commission many kind of Matter devices (Thread, Wi-Fi, Ethernet...).
...
| X-NUCLEO-NFC11A1-S
a| STMicroelectronics's NFC expansion board.
NB: This board is not yet available on the market. Please contact tania.guidet@st.com to obtain it.

| HID OMNIKEY 5022 CL
a| NFC/RFID contactless reader. Connected to the Raspberry Pi via USB. Host uses the PC/SC driver to communicate with it.
This NFC Reader shall be used when testing NFC commissioning on a *DUT as Commissionee*.

|===

In case of nfc-thread commissioning, an nRF52840 Dongle, from Nordic, should also be setup.
...
STM32WBA65I-DK1 firmware ("STM32WBA65I-DK1-lighting_v2.1.0forDV0.8.1.bin") is available in Matter 1.6 SVE package.
...
An virtual COM port connection can be setup either to check the Software version or to see the debug traces:
* Speed: 921600
* Data: 8 bit
* Parity: None
* Stop bits: 1 bit
...
=== Test Procedures and Test Commands
The test procedures and test commands for NFC commissioning are documented in the Test Plan Verification spreadsheet under the Matter Specifications and Test Plans folder (eg: TC_DD_1_5, TC_DD_3_22, TC_DD_3_23, TC_DD_3_24):
https://groups.csa-iot.org/wg/members-all/document/folder/2269 *or* https://docs.google.com/spreadsheets/d/19ZAbIRObi1HcvbesI4tSVmQn7cxz-ZNyFH80onmae7Y/edit?gid=311763523#gid=311763523
