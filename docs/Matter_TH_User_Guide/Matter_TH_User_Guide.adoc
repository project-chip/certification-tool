...
| Matter 1.3       | v2.10.4+spring2024 | N/A                                                                                         | https://groups.csa-iot.org/wg/members-all/document/folder/3361[Causeway Link] | 50bcad1      | To install, use the tag "v2.10.4+spring2024" in the instructions of <<fresh_install>>
