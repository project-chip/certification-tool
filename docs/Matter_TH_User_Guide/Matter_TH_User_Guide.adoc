...
:th-version: v2.14-beta1+fall2025
...
| Matter 1.5     | v2.14-beta1+fall2025   | N/A                                                                                         |  | 4da9496      | To install, use the tag "v2.14-beta1+fall2025" in the instructions of <<fresh_install>>
|===
