...
| Matter 1.4       | v2.11+fall2024 | N/A                                                                                         | https://groups.csa-iot.org/wg/members-all/document/folder/4120[Causeway Link]  | 803e819      | To install, use the tag "v2.11+fall2024" in the instructions of <<fresh_install>>
|===
