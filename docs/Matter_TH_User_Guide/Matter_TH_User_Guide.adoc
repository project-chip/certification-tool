...
| Matter 1.3       | v2.10.3+spring2024 | N/A                                                                                         | https://groups.csa-iot.org/wg/matter-csg/document/folder/3314[Causeway Link] | 50bcad1      | To install, use the tag "v2.10.3+spring2024" in the instructions of <<fresh_install>>
|===
...
| 27          | 01-Jul-2024  | [Apple]Hilton Lima                  | * Updated Test Harness links.
|===
