...
| Matter 1.6     | {th-version}       | N/A                                                                                         | https://groups.csa-iot.org/wg/members-all/document/folder/2269[Causeway Link] | b91b83f      | To install, use the branch "{th-version}" in the instructions of <<fresh_install>>
|===
