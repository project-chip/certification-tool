...
- [**Test Case Execution**](#test-case-execution)
  ...
  - [Simulated Tests (app1\_tests)](#simulated-tests-app1_tests)
...
TH runs on Ubuntu 22.04 Server LTS. It can be set up in a Raspberry Pi
([???](#th-image-installation-on-raspberry-pi)) or not
