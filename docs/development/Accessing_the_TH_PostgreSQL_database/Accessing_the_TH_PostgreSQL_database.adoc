...
`Username` / `Password`: These are stored in the *default.env* file in the https://github.com/CHIP-Specifications/chip-certification-tool[chip-certification-tool^] repo.
